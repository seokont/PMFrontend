...
const Tables = () => {
  ...
  const [openAffilii, setOpenAffilii] = useState(false);
  ...
  const isPlayers = useSelector(getPlayers);
  useEffect(() => {
  ...
  useEffect(() => {
    setRowData(isPlayers?.arrayPlayers);
  }, [isPlayers]);
